...
/*
    ...
    Cada cuenta, en caso de tenerlo, cuenta con un único gestor. Diseñar la clase Gestor
    de la que interesa guardar du nombre, teléfono y el importe máximo autorizado con el que
    pueden operar. Con respecto a los gestores, existen las siguientes restricciones:
        ● Un gestor tendrá siempre un hombre y un teléfono.
